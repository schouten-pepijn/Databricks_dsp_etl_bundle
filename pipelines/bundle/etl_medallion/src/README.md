...
This folder defines all source code for the 'poc_medallion_etl' pipeline:
...
* Take a look at the sample under "sample_users_poc_medallion_etl.py" to get familiar with the syntax.
